...
?>
	...
	<main role="main">
		...
		<section style="background-color:#12316A">
<!--		<div class="container"> -->
		...
		<form id="form1" action="#" method="POST" class="">
			...
			<div class="col-sm-6">
					...
					<div class="form-group form-block">
						...
						<select multiple class="form-control" name="type" id="type" required>
								...
								<option value="3"> Mobile Air Conditioning </option>
			...
			<div class="col-sm-6">
				...
				<div class="form-group form-block">
				 ...
				 <input name="manufacturer" type="text" class="form-control" id="manufacturer" aria-describedby="manufacturerHelp" placeholder="Enter Manufacturer" required>
				 <small id="manufacturerHelp" class="form-text text-muted">Ex: Sanyo </small>
				</div>
				<div class="form-group form-block">
				 ...
				 <small id="emailHelp" class="form-text text-muted">Ex:  </small>
				</div>
				...
				<div class="form-group form-block">
				 ...
				 <small id="websiteHelp" class="form-text text-muted">Ex:  </small>
				</div>
				<div class="form-group form-block">
				 <label for="country"><?php _e( 'Country Availability' ); ?></label>
